  ...
  return (
    <main className="min-h-screen bg-background pb-20 pt-32">
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        <button 
          onClick={() => router.back()}
          className="mb-8 flex items-center gap-2 text-xs font-black uppercase tracking-widest text-muted transition hover:text-foreground focus-gentle"
        >
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div className="flex-1">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest text-accent">Discovery Collection</span>
                </div>
            ...
            <div className="flex rounded-full border border-glass-border bg-glass-bg p-1.5 shadow-premium self-start md:self-end backdrop-blur-md">
                <button 
        ...
        <section className="mt-12 rounded-section border border-border bg-glass-bg p-8 shadow-premium backdrop-blur-md lg:p-12">
        ...
        <div className="mt-12">
            {viewMode === "map" ? (
                <motion.div 
                    ...
                    className="h-[60vh] w-full rounded-section overflow-hidden shadow-premium border border-border"
                >
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            >
                                {isOwner && (
                                    <button 
                                        ...
                                        className="absolute right-4 top-4 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-white/90 text-red-500 shadow-md backdrop-blur transition hover:bg-red-500 hover:text-white focus-gentle"
                                    >
                                ...
                                <Link
                                    ...
                                    className="flex h-[28rem] flex-col overflow-hidden rounded-card border border-border bg-surface shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-premium relative focus-gentle"
                                >
                                    <div className="relative h-2/3 overflow-hidden">
                                        <Image 
                                            src={getRestaurantImage(r as RestaurantWithRatings)} 
                                            alt={r.name}
                                            fill
                                            unoptimized
                                    ...
                                    <div className="flex flex-1 flex-col p-6 bg-surface relative">
                    ...
                    {list.items.length === 0 && (
                        <div className="col-span-full py-32 text-center rounded-section border border-dashed border-border bg-glass-bg backdrop-blur-sm shadow-premium">
