        ...
        >
          ...
          >
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg font-medium text-white/80 sm:text-xl">
              Escape the noise of anonymous reviews. Discover the city&apos;s
              finest plates guided purely by the people whose taste you trust.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <input
                ...
                aria-label="Search city, vibe, or restaurant"
                className="w-full bg-transparent py-5 pr-6 text-lg text-white placeholder-white/50 outline-none focus-gentle"
              />
              <button
                type="submit"
                aria-label="Search"
                className="absolute right-2 mr-1 rounded-full bg-accent px-8 py-3.5 font-bold text-white transition hover:bg-accent-strong focus-gentle"
              >
                Explore
              </button>
            </form>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3 text-sm font-medium text-white/70">
              ...
              {[
                ...
                <Link
                  key={tag}
                  href="/restaurants"
                  className="rounded-full border border-white/20 bg-white/5 px-4 py-1.5 transition hover:bg-white/20 hover:text-white focus-gentle"
                >
                  {tag}
                </Link>
              ))}
      ...
      <section className="relative z-20 mx-auto -mt-20 max-w-7xl px-6 pb-24 sm:px-10 lg:px-12">
        ...
        >
          ...
          <motion.div
            ...
            className="group relative flex h-[28rem] flex-col justify-between overflow-hidden rounded-card border border-border/50 bg-[#161210] p-10 text-white shadow-sm transition hover:shadow-premium md:col-span-5"
          >
          ...
          <motion.div
            ...
            className="group relative overflow-hidden rounded-card border border-border/50 bg-surface shadow-sm transition hover:shadow-premium md:col-span-7"
          >
            <Image
            ...
            <div className="relative flex h-[28rem] flex-col justify-end p-10 text-white">
              <div className="mb-4 flex items-center gap-2">
                <span className="rounded-full border border-white/30 bg-black/40 px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-white backdrop-blur-md">
                  Italian
                </span>
                <span className="flex items-center gap-1 rounded-full bg-white/95 px-3 py-1.5 text-xs font-bold text-accent shadow-sm backdrop-blur">
                  <Star className="h-4 w-4 fill-accent" aria-hidden="true" />{" "}
                  4.9
                </span>
              </div>
              <h2 className="mb-2 font-serif text-4xl leading-tight">
                L&apos;Antica Pizzeria
              </h2>
              <p className="mb-6 max-w-md text-base text-white/80">
                &quot;The absolute best Neapolitan crust out of Naples. A
                must-visit.&quot;
              </p>

              <Link
                href="/restaurants"
                aria-label="Read reviews for L'Antica Pizzeria"
                className="inline-flex items-center gap-2 font-bold uppercase tracking-widest text-accent transition hover:text-white focus-gentle"
              >
                Read reviews{" "}
          ...
          <motion.div
            ...
            className="group relative overflow-hidden rounded-card border border-border/50 bg-surface-strong p-10 shadow-sm transition hover:shadow-premium md:col-span-12 lg:col-span-12"
          >
            <div className="flex flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-xl">
                <div className="mb-6 inline-flex rounded-full border border-border/50 bg-white/80 px-4 py-1.5 text-xs font-black uppercase tracking-widest text-muted backdrop-blur-md">
                  <Users className="mr-2 inline h-4 w-4" /> Trusted Circles
                </div>
                <h2 className="font-serif text-5xl leading-tight text-foreground">
                  Follow plates, <br /> not crowds.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-muted">
                  The best recommendations don&apos;t come from a five-star
                  average compiled by strangers. They come from the people whose
                  culinary taste you actually respect.
                </p>
                <div className="mt-8 flex -space-x-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="relative h-16 w-16 overflow-hidden rounded-full border-4 border-surface-strong shadow-sm transition hover:scale-110 hover:z-10"
                      aria-label={`Follower ${user.name}`}
                    >
                      <Image
                        src={user.img}
                  ...
                  <div className="flex h-16 w-16 items-center justify-center rounded-full border-4 border-surface-strong bg-accent text-sm font-bold text-white shadow-sm">
                    +2k
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1">
                <div className="relative rounded-ui border border-glass-border bg-glass-bg p-6 shadow-premium backdrop-blur-md">
                  <p className="mb-4 font-serif text-xl italic text-foreground">
                    &quot;If Sarah recommended this, I&apos;m booking a table
                    tonight.&quot;
                  </p>
                  <div className="mt-4 flex items-center justify-between border-t border-border/40 pt-4">
                    ...
                    <Link
                      href="/register"
                      className="text-sm font-bold text-accent hover:underline focus-gentle rounded-md px-1"
                      aria-label="Join the community network"
                    >
                      Join the Network
                    </Link>
                  </div>
